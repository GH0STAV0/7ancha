...
<header>
    <div class="container">
        <div class="header"> 
            ...
            <nav>
                <ul class="nav_list">
                    ...
                    <li class="nav_item">
                       <button class="btnn-primary">Donate</button>
                    </li>
        ...
        <!--iframe data-aa='1916303' src='//ad.a-ads.com/1916303?size=728x90' style='width:728px; height:90px; border:0px; padding:0; overflow:hidden; background-color: transparent;'></iframe>  btn btn-outline-light     -->
         ...
         <div class=" col">
         <iframe data-aa='1916303' src='//ad.a-ads.com/1916303?size=970x90' style='width:728px; height:90px; border:0px; padding:0; overflow:hidden; background-color: transparent;'></iframe> </div>
         </div>

        <div class="row justify-content-between" id="address-box-normal">

            <div class=" col my-address-block">
                <span id="my-address"><?php echo $user->address ?></span>&nbsp;
            </div>
            <div class="my-address-block3">
            <button class="btnn-copy" data-clipboard-target="#my-address">Copy</button>
            </div>


            <div class="my-address-block2">

                <button type="button" class="btnn-change-email"
...
<footer>
    <div class="container">
        ...
        <div class="card card-body collapse" id="about" style="max-width: 40rem; background-color: #21262d;">
